...
function (_Component) {
  ...
  function Materials() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Materials).apply(this, arguments));
  }

  _createClass(Materials, [{
    key: "render",
    value: function render() {
      var attributes = this.props.attributes; // return null if no materials attribute

      if (!(attributes && attributes.materials)) return null;
      var materials = attributes.materials;
      var keys = Object.keys(materials); // return null if no keys

      if (!(keys && keys.length)) return null;
      return keys.map(function (key) {
        return _urdx.default.createElement(_Material.default, {
