...
function (_Component) {
  ...
  function Origin() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Origin).apply(this, arguments));
  }
  ...
  _createClass(Origin, [{
    ...
    value: function render() {
      ...
      return _urdx.default.createElement("origin", {
        xyz: xyzString(origin),
        rpy: rpyString(origin)
      });
    }
  }]);
