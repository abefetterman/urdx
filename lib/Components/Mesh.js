...
// Use sphere mass and inertia estimators with the scale length
function meshMass(r, density) {
  var rho = density || 1;
  return rho * 4 * Math.PI * Math.pow(r, 3) / 3.0;
}

function meshInertiaTensor(r, m) {
  return {
    ixx: (0, _utils.truncate)(2 * m * Math.pow(r, 2) / 5.0),
    ixy: 0,
    ixz: 0,
    iyy: (0, _utils.truncate)(2 * m * Math.pow(r, 2) / 5.0),
    iyz: 0,
    izz: (0, _utils.truncate)(2 * m * Math.pow(r, 2) / 5.0)
  };
}

var Mesh = function (_LinkComponent) {
  ...
  _createClass(Mesh, [{
    ...
    value: function renderVisual(props) {
      ...
      return _urdx2.default.createElement(
        ...
        _urdx2.default.createElement(
          'geometry',
          null,
          _urdx2.default.createElement('mesh', { filename: mesh })
        ),
    ...
    value: function renderCollision(props) {
      ...
      return _urdx2.default.createElement(
        ...
        _urdx2.default.createElement(
          'geometry',
          null,
          _urdx2.default.createElement('mesh', { filename: collisionMesh || mesh })
        ),
        _urdx2.default.createElement(_Origin2.default, { origin: origin })
      );
    }
    ...
    value: function renderInertial(props) {
      var parent = props.parent,
          attributes = props.attributes;
      var _attributes$length = attributes.length,
          length = _attributes$length === undefined ? 0.1 : _attributes$length,
          origin = attributes.origin;
      var material = attributes.material,
          mass = attributes.mass;

      if (!material && parent && parent.material) material = parent.material;
      if (!mass) mass = meshMass(length, material && material.density);
      var inertia = meshInertiaTensor(length, mass);
